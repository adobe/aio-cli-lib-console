...
module.exports = {
  ...
  validateProjectName: createValidator(
    ...
    'only contain English alphanumeric or Latin alphabet characters'
  ),
  validateProjectTitle: createValidator(
    ...
    'only contain English alphanumeric or Latin alphabet characters and spaces'
  ),
  validateProjectDescription: createValidator(
    'Project description',
    // empty || (string with spaces && contains at least one non-space char)
    /^$|^(?=.*\S)[-+!'"/\n\r#$%&*.,:;()=?\u0040-\uD800 0-9]{1,1000}$/,
    'contain English alphanumeric or Latin alphabet characters, spaces and common special characters'
  ),
